...
export default function Page({ params }: { params: { shopId: string, qr: string } }) {
  return (
    <section className="grid relative dark:bg-gray-800">
      <Profile />
      ...
      <div className="flex flex-col justify-center">
        <div className="sticky z-50 top-0 pt-4 bg-white dark:bg-slate-800 backdrop-filter backdrop-blur-lg bg-opacity-80 border-b border-gray-200 dark:border-slate-700">
          <div className="flex px-3 gap-1 max-w-[500px] m-auto">
            <Input
              type="text"
              placeholder="Tea / food / mandi / jus.."
              labelPlacement="outside"
              startContent={<Search className="text-2xl text-indigo-500 pointer-events-none flex-shrink-0" />}
            />
            <Button variant="shadow" className="bg-indigo-500">Go</Button>
          </div>
          {/* Categories */}
          <div className="flex p-3 gap-3 sm:justify-center w-screen lg:w-fit mx-auto overflow-x-auto">
